...
ratio_histogram_cap <- fig_nums(name='ratio_histogram', caption= 'Ratio of Service charge to total bill at 15 CCF.')
```
...
```
In addition, when computing the ratio between the percentage of fixed revenue to percentage of fixed costs, `r fig_nums("pct_fixed_rev", display = "cite")` shows that at least half of the agencies have their percentage of fixed revenue smaller than or equal to the percentage of fixed costs.
