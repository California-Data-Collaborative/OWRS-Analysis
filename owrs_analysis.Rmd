...
df_bill <- calculate_bills_for_all_utilities(merged_OWRS, supplier_reports, df_sample, owrs_path, customer_classes)
...
p <- plot_bill_frequency_piechart(df_final_bill)
...
p <- plot_mean_bill_pie(df_final_bill, singleTargetValue)
...
p <- plot_rate_type_pie(df_final_bill)
...
p <- plot_ratio_histogram(df_final_bill, singleTargetValue)
...
p <- plot_bill_histogram(df_final_bill, singleTargetValue)
...
df_final_bill <- assign_fuzzy_match_names(df_final_bill, 
...
p <- plot_eff_vs_bill(eff_vs_rate, singleTargetValue)
