...
not_matched <- fuzzy_check[which(fuzzy_check$fuzzy_match=="list()"),]
fuzzy_check <- fuzzy_check[which(!fuzzy_check$fuzzy_match=="list()"),]
paste("There were", nrow(no_matches), "NOT-MATCHED utilities.")
...
#write.csv(fuzzy_check[,c("utility_name", "fuzzy_match")], "data/correct_fuzzy_matches.csv",  row.names=FALSE)
